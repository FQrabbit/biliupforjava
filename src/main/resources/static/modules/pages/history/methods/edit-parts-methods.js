...
(function(window) {
    ...
    window.HistoryPageEditPartsMethods = {
        ...
        confirmDiscardUnsavedLocalEditParts: function(onConfirm) {
            ...
            this.$pageConfirm(message, '确认放弃未保存分P文件', {
                type: 'warning',
        ...
        notifyParentOperationStatus: function() {
            ...
            this.$emit('page-state', {
                ...
                blockingClose: active
            });
        },
        notifyParentDraftProtection: function() {
            const active = this.hasUnsavedLocalEditPartFiles();
            this.$emit('page-state', {
                kind: 'operation',
                source: 'history-edit-parts-draft',
                active: active,
                message: active ? '存在未保存的本地分P文件' : '',
                blockingClose: active
            });
        },
